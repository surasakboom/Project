...
<body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="getTeacherSubject(); getUserName(); getAnswerHistory();">
	          ...
	          <div class="">
	            <div class="page-title">
	              <div class="title_left">
	                <h3>ประวัติการตอบคำถาม</h3><!-- 
                        <form id="dateForm">
                          <span style="font-size: 20px;">ใส่วันที่: </span>
                          <input type="date" name="day" ng-model="day">
                          <button style="width: 60px; height: 30px;" type="button" class="btn btn-primary" ng-click="getAnswerHistory()">ตกลง</button>
                        </form> -->
                    <br>
	              </div>
	            </div>
                ...
                <span ng-show="no_answer_history">{{no_answer_history}}</span>
	            <div class="row" ng-hide="no_answer_history">
	              <div class="col-md-12">
	                <div class="x_panel">
	                  <div class="x_title">
	                    <h2>{{Question}}</h2>
	                  ...
	                  <div class="x_content">
	                    ...
	                    <table class="table table-striped projects">
	                      <thead>
	                        <tr>
                              ...
                              <th style="width: 10%">ผลลัพธ์</th>
	                        </tr>
	                      </thead>
	                      <tbody>
	                        <tr ng-repeat="answer in answer_history">
	                          <td>{{$index+1}}</td>
	                          <td>
	                            {{answer.Student_ID}}
	                          </td>
                              ...
                              <td>
                                <label ng-if="answer.Correct == 1" class="btn btn-success btn-xs"><i class="fa fa-check" ></i></label>
                                <label ng-if="answer.Correct == 0" class="btn btn-danger btn-xs"><i class="fa fa-times"></i></label>
                                <label ng-if="answer.Correct == -1"> - </label>
                              </td>
	                        </tr>
	                      </tbody>
	                    </table>
                        ...
                        &nbsp;&nbsp;<b>นักเรียนที่ส่งคำตอบทั้งหมด</b> {{correct_answer + wrong_answer}} คน<br>
                        &nbsp;&nbsp;<b>นักเรียนที่ไม่ส่งคำตอบทั้งหมด</b> {{not_send}} คน<br>
                        &nbsp;&nbsp;<b>นักเรียนที่ตอบถูก</b> {{correct_answer}} คน<br>
                        &nbsp;&nbsp;<b>นักเรียนที่ตอบผิด</b> {{wrong_answer}} คน<br>
	                </div>
	              </div>
	            </div>
	          </div>
