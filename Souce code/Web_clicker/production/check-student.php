...
<body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="getTeacherSubject(); getUserName(); sendSectoinID(); getStudentForCheck(); ">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="student-come.php"><i class="fa fa-home"></i> รายชื่อนักเรียนที่มาเรียน </a></li>
              ...
              <div class="">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>ชื่อวิชา {{SubjectName}} ตอนเรียน {{SubjectID}}</h2>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                        ...
                        <table class="table table-striped projects">
                          ...
                          <tbody>
                            <tr ng-repeat="check in check_student">
                              <td>{{$index+1}}</td>
                              <td>
                                  {{check.Student_ID}}
                              </td>
                              <td>
                                <a>{{check.FirstName}}  {{check.LastName}}</a>
                              </td>
                              <td>
                                <a ng-show="check.isCome" href="#" class="btn btn-success btn-xs"><i class="fa fa-check" ></i> มาเรียน </a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                        <!-- end project list -->
                        <span style="font-size: 15px;">&nbsp;&nbsp;<b>รวม : </b>{{check_student.length}} คน <br>&nbsp;&nbsp;<b>มาเรียน</b> {{student_come}} คน<br>&nbsp;&nbsp;<b>ขาดเรียน</b> {{check_student.length - student_come}} คน </span> 
