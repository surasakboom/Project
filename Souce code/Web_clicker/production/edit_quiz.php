...
<html lang="en">
  ...
  <body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="getQuestionById();getUserName(); show=false">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>กล่องคำถาม <small>different form elements</small></h2>
                    ...
                    <form id="demo" name="demo" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <textarea name="question" id="inputDescription" class="form-control" rows="4" required="required" ng-model="question.Quiz"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="choice1" name="choice1" required="required" class="form-control col-md-7 col-xs-12" ng-model="question.Choice1">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="choice2" name="choice2" required="required" class="form-control col-md-7 col-xs-12" ng-model="question.Choice2">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="choice3" required="required" class="form-control col-md-7 col-xs-12" ng-model="question.Choice3">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="choice4" required="required" class="form-control col-md-7 col-xs-12" ng-model="question.Choice4">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="answer" class="btn-group" data-toggle="buttons" style="margin-top: 10px;">
                            <p>
                              <input type="radio" name="choice" id="genderM" value="1" required ng-model="question.Answer"/> ข้อที่ 1&nbsp
                              <input type="radio" name="choice" id="genderM" value="2" required ng-model="question.Answer"/> ข้อที่ 2 &nbsp 
                              <input type="radio" name="choice" id="genderM" value="3" required ng-model="question.Answer"/> ข้อที่ 3 &nbsp 
                              <input type="radio" name="choice" id="genderM" value="4" required ng-model="question.Answer"/> ข้อที่ 4

                              <!-- <input type="radio"  name="choice" id="genderM" value="1" required ng-model="checkboxSelection"/> Checkbox 1
                              <input type="radio"  name="choice" id="genderM" value="2" required ng-model="checkboxSelection"/> Checkbox 2 -->
                            </p>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <textarea name="description" id="inputDescription" class="form-control" rows="4" required="required" ng-model="question.Answer_Description"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <!--<input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12">-->
                           <input type="number" step="any" id="point" name="point" required="required" class="form-control col-md-7 col-xs-12" string-to-number ng-model="question.Point">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="lecture" required="required" class="form-control col-md-7 col-xs-12" ng-model="question.Lecture">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success" ng-click="updateQuestion()">บันทึก</button>
                        </div>
                      </div>
                    </form>
                  </div>
