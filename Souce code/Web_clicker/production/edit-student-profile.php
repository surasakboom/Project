                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="form_signup" name="form_signup" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">รหัสนักศึกษา <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="student_id" name="student_id" required="required" class="form-control col-md-7 col-xs-12" ng-model="student_id">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-primary" ng-click="editStudentProfile()">บันทึก</button>
