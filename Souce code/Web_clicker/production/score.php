...
<body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="setYear(); getUserName(); getScore();show=false">
              ...
              <div class="">
                ...
                <div class="row">
                  ...
                  <div class="">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>ชื่อวิชา {{subjectName}} ตอนเรียน {{sectionId}}</h2>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                        ...
                        <table class="table table-striped projects">
                          <thead>
                            <tr>
                              ...
                              <th style="width: 30%">ชุดคำถาม</th>
                              <th style="width: 10%">จำนวนข้อ</th>
                              <th style="width: 10%">ตอบถูก</th>
                              <th style="width: 10%">ตอบผิด</th>
                              <th style="width: 10%">คะแนนที่ได้</th>
                              <th style="width: 10%">คะแนนทั้งหมด</th>
                            </tr>
                          </thead>
                          <tbody>
