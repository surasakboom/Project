...
<body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="getTeacherSubject(); getUserName(); getStudentScore();">
                        ...
                        <table class="table table-striped projects">
                          <thead>
                            <tr>
                              ...
                              <th style="width: 10%">ตอบถูก</th>
                              <th style="width: 10%">ตอบผิด</th>
                              <th style="width: 10%">คะแนนที่ได้</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr ng-repeat="score in students_score">
                              <td>{{$index+1}}</td>
                              <td>
                                  {{score.Student_ID}}
                              </td>
                              <td>
                                <a>{{score.FirstName}}  {{score.LastName}}</a>
                              </td>
                              <td>
                                {{score.Correct}}
                              </td>
