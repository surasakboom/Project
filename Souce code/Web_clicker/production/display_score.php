...
<body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="getTeacherSubject(); getUserName(); getStudentScorePass();getStudentScore();">
                    ...
                    <div class="x_panel">
                      ...
                      <div class="x_content">
                        ...
                        <table class="table table-striped projects">
                          ...
                          <tbody>
                            <tr ng-repeat="student in students | orderBy : '-Total'">
                              <td>{{$index+1}}</td>
                              <td>
                                  {{student.Student_ID}}
                              </td>
