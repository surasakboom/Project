                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo" name="demo" class="form-horizontal form-label-left">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="prefix" class="btn-group" data-toggle="buttons" style="margin-top: 10px;">
                            <p>
                              ...
                              <input type="radio" name="prefix" id="prefix" value="นาง" required ng-model="prefix" disabled /> นาง&nbsp 
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">ชื่อย่อ </span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="shortname" name="shortname" required="required" class="form-control col-md-7 col-xs-12" ng-model="shortname" readonly>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="reset" class="btn btn-primary" ng-click="goto('teacher-home.php')">ตกลง</button>
                          <button type="submit" class="btn btn-success" ng-click="goto('edit-teacher-profile.php')">แก้ไข</button>
                        </div>
                      </div>
                    </form>
                  </div>
