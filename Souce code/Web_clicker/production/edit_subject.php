...
<html lang="en">
  ...
  <body class="nav-md" ng-app="myapp" ng-controller="utilCtrl" ng-init="retriveSubject(); getUserName(); show=false">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>สร้างวิชา <small>different form elements</small></h2>
                    ...
                    <form id="demo-form2" class="form-horizontal form-label-left" method="GET" action="php/subject.php">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="question" name="subject_id" required="required" class="form-control col-md-7 col-xs-12" ng-model="subject.Subject_ID">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="choice1" name="subject_name" required="required" class="form-control col-md-7 col-xs-12" ng-model="subjectName">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="class" required="required" class="form-control col-md-7 col-xs-12" ng-model="subject.Class">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="term" required="required" class="form-control col-md-7 col-xs-12" ng-model="subject.Term">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="year" required="required" class="form-control col-md-7 col-xs-12" ng-model="subject.Years">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="classroom" class="form-control col-md-7 col-xs-12" ng-model="subject.Classroom">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="day" required="required" placeholder="จ,อ,พ,พฤ,ศ" class="form-control col-md-7 col-xs-12" ng-model="subject.Day">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="time" id="last-name" name="start" required="required" class="form-control col-md-7 col-xs-12" ng-model="TimeStart">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="time" id="last-name" name="end" required="required" class="form-control col-md-7 col-xs-12" ng-model="TimeEnd">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="period" required="required" class="form-control col-md-7 col-xs-12" ng-model="subject.Period">
                        </div>
                      </div>
                      <input type="text" id="q" name="q" value="edit_subject" hidden>
                      <input type="text" id="section_id" name="section_id" ng-value="subject.id" hidden>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="reset" class="btn btn-primary"><a href="teacher-home.php" style="color: white;">ยกเลิก</a></button>
